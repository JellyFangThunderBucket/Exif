...
import { buildExifArgs, ensureTempRoot, isAllowedMime, randomId, resolveTemp, runExiftool, safeBasename, presets } from './exiftool.js';
...
async function handler(req, res) {
  try {
    ...
    if (req.method === 'GET' && url.pathname === '/api/config') return json(res, 200, { maxUploadBytes: config.maxUploadBytes, presets });
